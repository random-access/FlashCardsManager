...
public class DerbyDBExchanger {

    private final String driver = getDriver(); // db-driver
    protected final String protocol = getProtocol(); // database protocol
    protected final String dbLocation; // path to database

    protected final String projectsTable = "PROJECTS";
    protected final String flashcardsTable = "FLASHCARDS";
    protected final String labelsTable = "LABELS";
    protected final String labelsFlashcardsTable = "LABELS_FLASHCARDS";
    protected final String mediaTable = "MEDIA";
    protected final int maxShortString = 1000;
    protected final int maxVarcharLength = 32672;

    protected Connection conn; // connection
    protected ProjectsController ctl;

    public DerbyDBExchanger(String dbLocation, ProjectsController ctl) throws ClassNotFoundException {
