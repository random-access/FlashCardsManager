					...
					for (String imgName : images.keySet()) {
						...
						if (question.contains(imgName)) {
							...
							if (startpos != -1 && endpos != -1) {
								...
								startpos = question.indexOf("<org.random_access.flashcardsmanager_desktop.img");
						...
						if (answer.contains(imgName)) {
							...
							int startpos = answer.indexOf("<org.random_access.flashcardsmanager_desktop.img");
							int endpos = answer.indexOf("/>", startpos);
							if (startpos != -1 && endpos != -1) {
								answer = answer.substring(0, startpos) + answer.substring(endpos + 2, answer.length());
								startpos = answer.indexOf("<org.random_access.flashcardsmanager_desktop.img");
