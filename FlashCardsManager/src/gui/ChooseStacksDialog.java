...
public class ChooseStacksDialog extends JDialog {
   ...
   // while constructing an empty session, and are needed e.g. in LearningSession
   ...
   // CONSTRUCT SESSION: constructs session with cards from selected stacks in order from database entries
